...
public class TestWriter_modified implements RecordWriter {
    ...
    public TestWriter_modified(final File file, final TocWriter writer, final boolean compressed, final int uncompressedBlockSize) throws IOException {
